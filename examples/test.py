...
# python examples/test.py --method=POS --video_path=examples/sample_video_2.mp4 --vitals_path=examples/sample_vitals_2.csv
#                            Algorithm   video path                               Ground Truth Path csv file